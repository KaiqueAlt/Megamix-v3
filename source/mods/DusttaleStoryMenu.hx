...
class DusttaleStoryMenu extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (FlxG.sound.music != null)
		{
			if (!FlxG.sound.music.playing)
				FlxG.sound.playMusic(Paths.music('mods/dusttale'));
		}
		...
		var ui_tex = Paths.getSparrowAtlas('dusttale/story_mode');
		var arrow_tex = Paths.getSparrowAtlas('dusttale/arrow');
		var yellowBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, 0xFFF9CF51);
		var heart = Paths.getSparrowAtlas('dusttale/start_soul');
		...
		menubg.frames = Paths.getSparrowAtlas('dusttale/menu');
        menubg.animation.addByPrefix('bg', 'bg', 24, true);
        add(menubg);
        menubg.visible = true;

        var bg2 = new FlxSprite(0, 0).loadGraphic(Paths.image("dusttale/menu_story_mode"));
		...
		var madTime = new FlxSprite(0, 0).loadGraphic(Paths.image("dusttale/mad_time"));
